...
const EventSchedule = () => {
  ...
  const hackathonStartDate = new Date("2025-07-24T08:00:00");
    ...
    return (
      <div className="relative" style={{ width: `${totalWidth}px` }}>
        {organizedTimeSlots.map((timeSlot, timeSlotIndex) => (
          <div key={`timeslot-${timeSlotIndex}`} className="relative">
  ...
  const renderMobileSchedule = (): JSX.Element => {
    return (
      <div className="flex flex-col gap-6 pb-6" style={{ width: "100%" }}>
        {organizedTimeSlots.map((timeSlot, timeSlotIndex) => (
          <div
