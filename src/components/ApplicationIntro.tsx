...
export default function ApplicationIntro({
  ...
  return (
    <div className="p-4 flex flex-col items-center gap-4 lg:gap-6 w-full">
      <RedGradientBackground className="w-full p-6 rounded-2xl flex flex-col gap-4 text-white shadow-md">
        <h1 className="text-xl font-bold">We're glad you're here.</h1>
        <p>{applicationIntro}</p>
        <div>
          <p>Date: <b>24 - 26 July 2025</b></p>
          <p>Venue: <b>Universitas Multimedia Nusantara</b></p>
        </div>
