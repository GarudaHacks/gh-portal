...
export default function ApplicationOpenSoon({ portalConfig }: ApplicationOpenSoonProps) {
  ...
  return (
    <div className="w-full p-8 border border-tertiary grid grid-cols-1 lg:grid-cols-5 gap-10 bg-white rounded-xl border-tertiary-glow">
      ...
      <div className="col-span-1 lg:col-span-3 flex flex-col gap-6 lg:gap-4">
      ...
      <div className="text-center items-center flex flex-col gap-2">
        ...
        <Button
          className={`w-full ${!portalConfig?.applicationsOpen ? "opacity-90 cursor-not-allowed" : ""
            }`}
        ...
        <p className="text-xs text-muted">We'll notify you by email</p>
      </div>
    </div>
  )
}