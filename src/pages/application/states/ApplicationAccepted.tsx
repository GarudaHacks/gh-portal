  ...
  return (
    <div className="flex flex-col gap-10 text-pretty p-4">
      ...
      <div ref={rsvpRef} className="text-center flex flex-col gap-2 p-4  bg-cover bg-center rounded-xl">
        ...
        <p className="text-pretty max-w-2xl mx-auto">Hit confirm below to lock in your spot by <b>14th of July at 23.59 WIB</b>. Please note that we unfortunately won't be able to hold spots that aren't confirmed.</p>
        <div className="h-6" />
